...
class ResultTable {
  ...
  setupDefault() {
    this.table.push([{
      'colSpan': 3,
      'hAlign': 'center',
      'content': chalk.inverse('The coach: Clear Eyes. Full Hearts. Can’t Lose. Version ' + this.result.version)
    }]);
  ...
  setupInfo() {
    ...
    Object.keys(advice.info).forEach(function(key) {
      table.push([key, {
        'colSpan': 2,
  ...
  setupTimings() {
    ...
    Object.keys(advice.timings).forEach(function(timing) {
      table.push([timing, {
        'colSpan': 2,
