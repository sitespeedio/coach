(function() {
  ...
  return {
    ...
    description:
      'Using HTTP/2 together with HTTPS is the new best practice. If you use HTTPS (you should), you should also use HTTP/2 since you will then get compressed headers. However it may not be faster for all users.',
    advice: message,
    score: score,
    weight: 2,
    offending: [],
