...
(function() {
  ...
  if (url.length > 100) {
    score -= 10;
    message += 'Your URL is ' + url.length + ' character long. Try to make it smaller than 100 characters. '
  }

  if (url.indexOf(' ') > -1 || url.indexOf('%20') > -1) {
    score -= 10;
    message += 'Are you or your CMS on Windows? Avoid using spaces in your URLs, use hyphens or underscores. '
  }
