...
(function() {
  ...
  return {
    ...
    advice: (score > 0) ? ('The page has ' + missing + ' images that missing alt attribute(s) ' + (tooLong > 0) + '. '? ' The page has ' + tooLong + ' where the alt text are  too long (longer than 125 characters).' : ''):'',
