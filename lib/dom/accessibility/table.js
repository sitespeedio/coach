/**
 * @fileoverview Use caption and th in tables
...
(function() {
  ...
  return {
    ...
    advice: score > 0 ? 'You have tables that are missing caption, please use them to give them a proper heading or summary.':'',
