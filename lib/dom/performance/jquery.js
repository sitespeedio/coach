/**
 * @fileoverview Use maximum one JQuery version per page.
...
(function() {
  ...
  return {
    ...
    advice: versions.length > 1 ? 'The page uses ' + versions.length + ' versions of JQuery! You only need max one, so please remove the other version(s).'  : '',
