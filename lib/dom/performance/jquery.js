(function() {
  ...
  return {
    ...
    description: 'You may not think this is true, but there are pages that use more than one jQuery version.',
    advice: versions.length > 1 ? 'The page uses ' + versions.length + ' versions of jQuery! You only need one version, please remove the unnecessary version(s).'  : '',
