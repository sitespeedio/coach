(function(util) {
  ...
  if (score>0) {
    message = 'The page has ' + (score/10) + ' images that are scaled more than ' + minLimit + ' pixels. It would be better if those images are sent so the browser don\'t need to scale them. Here\'s the images: '+ message;
  }
