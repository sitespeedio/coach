(function(util) {
  ...
  return {
    ...
    advice: offending.length > 0 ? 'The page has ' + offending.length + ' CSS files requested from another domain than the main document. Move them to the main domain so that the browser get rid of the DNS lookup.' : '',
