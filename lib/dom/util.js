/**
 * @fileoverview Utilities for getting common knowledge from the DOM.
 * @exports coach/util
 * @namespace util
...
var util = {
  ...
  /**
   * Do the element exists in the Array
   *
   * @memberof util
  ...
  /** Get Resource Hints hrefs by typeo
   * @memberof util
   * @param {String} the name of the Resources hint: dns-prefetch, preconnect, prefetch, prerender
  ...
  getCSSFiles: function(parentElement) {
    ...
    return links.filter(function(link) {
        // make suer we skip data:
        return (link.rel === 'stylesheet' && link.href.indexOf('http') > -1);
      })
      .map(function(link) {
