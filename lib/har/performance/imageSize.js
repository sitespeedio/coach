...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'The page total image size is ' + util.formatBytes(contentSize) + '. It\'s really big. Are the page using the right format for the images? Are they compressed as good as they can? Make them smaller by using ImageOptim.' : ''
    };
  }
