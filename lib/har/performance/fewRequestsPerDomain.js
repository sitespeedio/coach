  ...
  processPage: function(page) {
    ...
    if (util.isHTTP2(page)) {
      return {
        ...
        offending: [],
        advice:
          'There are almost no limits on HTTP/2 connections with the number of requests, but it is not completely true. It depends on how they are downloaded. Please check your HAR file, does it look OK?'
      };
    }
