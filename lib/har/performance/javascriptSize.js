...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'The page total Javascript transfer size is ' + util.formatBytes(transferSize) + '. That is really big and you should check what you can do to make it smaller.' : ''
    };
  }
