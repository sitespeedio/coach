...
module.exports = {
  ...
  processPage: function(page) {
    ...
    let cssAssets = page.assets.filter((asset) => asset.type === 'js');
    let transferSize = 0;
    let contentSize = 0;
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'Your total Javascript transfer size is ' + transferSize + ' & the total content size is ' + contentSize + '. That is really big and you should check what you can do to make it smaller' : ''
    };
  }
