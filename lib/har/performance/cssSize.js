...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'Your total CSS transfer size is ' + transferSize + ' & the total content size is ' + contentSize + '. That is really big and you should check what you can do to make it smaller' : ''
    };
  }
