...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'The page total CSS transfer size is ' + util.formatBytes(transferSize) + (contentSize > transferSize ? ' and uncompressed size of ' + util.formatBytes(contentSize): '') + '. That is really big and the CSS could most probably be smaller.' : ''
    };
  }
