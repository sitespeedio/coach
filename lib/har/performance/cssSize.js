...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      score: score,
      offending: [],
      advice: score < 100 ? 'The total CSS transfer size is ' + util.formatBytes(transferSize) + (contentSize > transferSize ? ' and uncompressed size is ' + util.formatBytes(contentSize): '') + '. ' +
      contentSize > 20000000 ? 'Wow, i\'s insane to need that amout of CSS to render a page.' : 'That is big and the CSS could most probably be smaller.' : ''
    };
  }
