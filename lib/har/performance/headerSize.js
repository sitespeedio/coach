  ...
  processPage: function(page) {
    ...
    if (util.isHTTP2(page)) {
      return {
        score: 100,
        offending: [],
        advice: 'The page use a HTTP/2 connection and the headers are sent compressed, that\'s good. And with the current version cannot say if the size is good or not.'
      };
    } else {
