...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      ...
      offending: offending,
      advice: score < 100 ? 'The page has ' + offending.length + ' requests to a domain where the connection had already been closed. Don\'t close the connection attempt to reuse by using keep alive!' : ''
    };
  }
};
