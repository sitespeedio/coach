...
module.exports = {
  ...
  description: 'Cache responses at least 30 days is good',
  weight: 3,
  ...
  processPage: function(page) {
    ...
    return {
      ...
      offending: offending,
      advice: score < 100 ? 'The page has ' + offending.length + ' request(s) that have a shorter cache time than 30 days (but still a cache time).' : ''
    }
  }
};
