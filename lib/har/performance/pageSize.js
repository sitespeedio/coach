...
module.exports = {
  ...
  processPage: function(page) {
    if (page.transferSize > 2000000) {
      return {score: 0, offending: [], advice:'The page total transfer size is ' + util.formatBytes(page.transferSize) + ', which is more than the limit 2 MB. That is really big and you should check what you can do to make it smaller.'};
    }
