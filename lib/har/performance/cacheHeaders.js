...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      ...
      offending: offending,
      advice: score < 100 ? 'The page has ' + offending.length + ' request(s) that are missing a cache time. Configure a cache time so the browser doesn\'t need to download them every time.' : ''
    }
  }
};
