...
let types = ['json', 'js', 'css', 'image', 'font'];
...
module.exports = {
  ...
  processPage: function(page) {
    ...
    return {
      ...
      offending: offending,
      advice: score < 100 ? 'You got ' + offending.length + ' requests with private headers. That doesn\'t seems to be right, they are cacheable for that specific user and not for everyone.' : ''
    }
  }
};
