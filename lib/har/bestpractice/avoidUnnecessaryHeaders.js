...
module.exports = {
  id: 'avoidUnnecessaryHeaders',
  title: 'Avoid Unnecessary Headers',
  description:
    "Do not send headers that you don't need. We look for p3p, cache-control and max-age, pragma and x-frame-options headers. We also look for extra long headers and responses with many headers. Have a look at Andrew Betts - Headers for Hackers talk as a guide https://www.youtube.com/watch?v=k92ZbrY815c",
  weight: 1,
  tags: ['bestpractice'],
  processPage: function(page) {
    ...
    page.assets.forEach(function(asset) {
      ...
      for (let name of headerNames) {
        if (asset.headers.response[name].length > 600) {
          offending.push(asset.url);
          score -= 1;
          advice +=
            asset.url +
